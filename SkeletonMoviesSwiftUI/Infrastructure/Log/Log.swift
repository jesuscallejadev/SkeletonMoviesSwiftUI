...
private func Log(_ log: String, filename: NSString = #file, line: Int = #line, funcname: String = #function) {
    guard LogManager.shared.logLevel != .none else { return }
    let appName = LogManager.shared.appName ?? "Skeleton Movies Log Manager"
